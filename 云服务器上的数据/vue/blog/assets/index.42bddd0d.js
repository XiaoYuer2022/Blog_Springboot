...
}`;be(Be);$.render=Se;$.__file="src/lib/Danmaku.vue";const Ee=n=>(ge("data-v-c179e845"),n=n(),ye(),n),$e={class:"message-container"},Le=Ee(()=>p("h1",{class:"message-title"},"\u7559\u8A00\u677F",-1)),Ne={class:"message-input"},Ae=["onKeyup"],De={class:"danmaku-container"},Ie={class:"danmaku-item"},ze=["src"],We={class:"ml"},Fe={class:"ml"},Me=T({__name:"index",setup(n){const{blog:r,user:c}=re(),o=d(""),a=d(!1),v=d(),k=d([]);R(async()=>{await Ce().then(({data:x})=>{k.value=x.data})});const w=()=>{var S;if(o.value.trim()=="")return(S=window.$message)==null||S.warning("\u7559\u8A00\u5185\u5BB9\u4E0D\u80FD\u4E3A\u7A7A"),!1;const x=c.avatar?c.avatar:r.blogInfo.siteConfig.touristAvatar,m=c.nickname?c.nickname:"\u6E38\u5BA2";let u={avatar:x,nickname:m,messageContent:o.value};ke(u).then(({data:_})=>{var y,i;_.flag&&(r.blogInfo.siteConfig.messageCheck?(y=window.$message)==null||y.warning("\u7559\u8A00\u6210\u529F\uFF0C\u6B63\u5728\u5BA1\u6838\u4E2D"):(v.value.push(u),(i=window.$message)==null||i.success("\u7559\u8A00\u6210\u529F")),o.value="")})};return(x,m)=>(H(),V(pe,null,[p("div",$e,[Le,p("div",Ne,[z(p("input",{class:"input","onUpdate:modelValue":m[0]||(m[0]=u=>W(o)?o.value=u:null),onClick:m[1]||(m[1]=u=>a.value=!0),onKeyup:me(w,["enter"]),placeholder:"\u8BF4\u70B9\u4EC0\u4E48\u5427"},null,40,Ae),[[ce,B(o)]]),z(p("button",{class:"send",onClick:w},"\u53D1\u9001",512),[[fe,B(a)]])])]),p("div",De,[ve(B($),{ref_key:"danmaku",ref:v,class:"danmaku","use-slot":"",danmus:B(k),"onUpdate:danmus":m[2]||(m[2]=u=>W(k)?k.value=u:null),"is-suspend":!0},{dm:he(({danmu:u})=>[p("span",Ie,[p("img",{src:u.avatar,width:"30",height:"30",style:{"border-radius":"50%"}},null,8,ze),p("span",We,F(u.nickname)+" :",1),p("span",Fe,F(u.messageContent),1)])]),_:1},8,["danmus"])])],64))}});const Re=_e(Me,[["__scopeId","data-v-c179e845"]]);export{Re as default};
